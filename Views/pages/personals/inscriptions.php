...
<div class="w-full flex justify-between flex-col items-center py-1 mb-4 md:px-3 min-h-max h-auto rounded shadow bg-white">
    <div class="border border-gray-500 mb-2 rounded w-full text-gray-800 font-semibold p-2 flex justify-between">
        ...
        <span class="w-1/12 hidden md:flex text-center">Matricule</span>
        <span class="w-2/12 text-center">Fonction</span>
        <span class="w-2/12 hidden md:flex text-center">Type de personel</span>
        <span class="w-1/12 text-center">Action</span>
    </div>
    <?php foreach($params['personals'] as $s) :?>
    <div class="border rounded w-full flex-nowrap overflow-x-auto mb-3 items-center text-gray-700 font-semibold p-2 flex justify-between">
        ...
        <span class="w-1/12 hidden md:flex text-center"><?=$s->registration_number?></span>
        <span class="w-2/12 text-center"><?= $s->f_name?></span>
        <span class="w-2/12 hidden md:flex text-center"><?= $s->personal_type?></span>
