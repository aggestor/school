    ...
    <div class="w-full flex justify-between">
       ...
       <?php if(isset($_SESSION['admin'])) :?> <div class="flex w-4/12 items-center justify-between"> <?php else : ?>
        <div class="flex w-3/12 items-center justify-between"> <?php endif ; ?>
            ...
            <?php if(isset($_SESSION['admin'])) : ?><a href="/admin/personals/confirm/<?=$personal->registration_number?>" class="p-1.5 bg-green-500 flex justify-between rounded hover:bg-green-600 text-white">Confirmer<span class="fas fa-check-circle ml-3 mt-1"></span></a> <?php endif;?>
        </div>
    </div>
    <!--First section-->
