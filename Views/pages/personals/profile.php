...
<div class="<?=$data = isset($_SESSION['admin']) ?'w-[98%]' : 'w-11/12' ?> rounded-shadow mx-auto p-4 bg-white">
    <div class="w-full flex justify-between">
        ...
        <h1 class="text-center font-bold text-lg md:text-xl lg:text-2xl text-gray-800">
       ...
       <?php if(isset($_SESSION['admin']) AND $params['personal']->is_registered != 1) :?> <div class="flex w-4/12 items-center justify-between"> <?php else : ?>
        ...
        <?php if(isset($_SESSION['admin'])) : ?>
            <a href="/admin/personals/modify/<?=$personal->registration_number?>" class="p-1.5 bg-gray-100 flex justify-between rounded hover:bg-gray-200"><span class="lg:flex hidden">Modifier</span> <span class="fas fa-pen text-gray-500 lg:ml-3 mt-1"></span></a>
            <?php else : ?>
                <a href="/profile/modify" class="p-1.5 bg-gray-100 flex justify-between rounded hover:bg-gray-200"><span class="lg:flex hidden">Modifier</span> <span class="fas fa-pen text-gray-500 lg:ml-3 mt-1"></span></a>
                <?php endif;?>
           <a href="<?=$d =isset($_SESSION['admin']) ?  '/admin/personals/docs/'.$personal->id:'/profile/docs'?>" class="p-1.5 bg-gray-100 flex justify-between rounded hover:bg-gray-200"><span class="lg:flex hidden">Mes dossiers</span> <span class="fas fa-folder text-gray-500 lg:ml-3 mt-1"></span></a>
    ...
    <!--First section-->
    <div class="w-full mt-4 lg:h-72 h-auto md:space-x-3 md:grid-cols-6 grid-cols-3 grid lg:grid-cols-12">
