...
<section class="w-full flex items-center flex-col justify-center">
    <main class="h-auto w-full md:w-11/12 border-r-2 border-white border-b-2 mb-12 bg-white rounded-lg shadow shadow-gray-400">
        <div class="w-11/12 mb-2 mx-auto">
            <h2 class="text-sky-500 font-semibold text-xl mt-2 text-center">School Archive Manager.</h2>
            <h2 class="text-black font-semibold text-lg mt-2 text-center">Modification du personnel : <span class="text-sky-500"><?=$personal->registration_number?></span></h2>
        </div>
          <form  method="POST" enctype="multipart/form-data" class="md:w-full w-11/12 mx-auto h-auto  flex justify-center flex-col">
            <div  id="identity" class="w-full register-menu grid md:grid-cols-2 grid-cols-1">
                ...
                <div class="col-span-1">
                    <div class="mx-auto h-40 w-40 rounded-full relative">
                        <img id="imageContainer" src="/files/users/<?=$personal->picture?>" class="w-full z-10  rounded-full h-full object-cover">
