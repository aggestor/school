<div class="w-full flex justify-between items-center py-1 mb-4 px-3 h-14 rounded shadow bg-white">
    ...
    <span class="text-white bg-sky-500 rounded p-1.5"><?=count($params['students'])?></span>
</div>
<div class="w-full flex justify-between flex-col items-center py-1 mb-4 px-3 min-h-max h-auto rounded shadow bg-white">
    ...
    <div class="border rounded w-full mb-3 items-center text-gray-700 font-semibold p-2 flex justify-between">
        ...
        <span class="w-1/12 flex justify-center">
            <a class="mr-2 h-8 w-8 rounded bg-gray-800 text-white grid place-items-center" href="/admin/students/<?=$s->registration_number?>"><span class="fas fa-eye"></span></a>
            <a class="mr-2 h-8 w-8 rounded bg-red-500 text-white grid place-items-center" href="/admin/students/lock/<?=$s->registration_number?>"><span class="fas fa-lock"></span></a>
        </span>
    </div>
    <?php endforeach?>
</div>