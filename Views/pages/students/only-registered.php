...
<div class="md:w-full overflow-auto  justify-between flex-col items-center py-1 mb-4 px-3 min-h-max h-auto rounded shadow bg-white">
    ...
    <div class="border hidden rounded md:w-full w-fit mb-3 items-center text-gray-700 font-semibold p-2 md:flex flex-col md:flex-row justify-between">
    ...
    <div class="md:border border-b md:border-b-0 md:hidden space-y-2 rounded md:w-full grid grid-cols-2 mb-3 items-center text-gray-700 font-semibold p-2">
