<div class="w-full h-full flex justify-center items-center">
    <div class="w-6/12 flex justify-between  shadow bg-white h-[350px] rounded">
        <div class="w-1/2 flex flex-col h-full items-center justify-center">
            <h1 class="text-green-500 text-xl w-10/12 font-semibold mb-3">Modification éffectué !</h1>
            <p class="w-10/12 text-gray-500">La modification de votre document a été effectuée avec succès. Il est maintenant parmis les dossiers que vous possedez !</p>
