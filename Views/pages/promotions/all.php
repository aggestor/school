<div class="w-full flex justify-between items-center py-1 mb-4 px-3 h-14 rounded shadow bg-white">
    <h1 class="text-gray-800 font-semibold text-lg flex items-center"> <a class="w-8 h-8 rounded-full bg-sky-500 text-white grid place-items-center mr-3" href="javascript:history.back()"><span class="fas fa-arrow-left"></span></a>Liste des promotions</h1>
...
<div class="w-full flex justify-between flex-col items-center py-1 mb-4 px-3 min-h-max h-auto rounded shadow bg-white">
    <div class="border border-gray-500 mb-2 rounded w-full text-gray-800 font-semibold p-2 flex justify-between">
        ...
        <span class="w-2/12 hidden md:flex text-center">Faculté</span>
        <span class="md:w-2/12 w-3/12 text-center">Départément</span>
        <span class="w-2/12 hidden md:flex text-center">Derniére Modif.</span>
        <span class="md:w-1/12 w-2/12 text-center">Action</span>
    </div>
    ...
    <div class="border rounded w-full mb-3 items-center text-gray-700 font-semibold p-2 flex justify-between">
        ...
        <span class="w-1/12 hidden md:flex text-center"><?=$prom->acronym?></span>
        <span class="w-2/12 hidden md:flex text-center"><?=$prom->fac_name?></span>
        <span class="md:w-2/12 w-3/12 text-center"><?=$prom->dep_name?></span>
        <span class="w-2/12 hidden md:flex text-center text-green-500">Jamais</span>
        <span class="md:w-1/12 w-2/12 flex justify-center">
