          ...
          <form action="/login" method="POST" class="w-5/12 h-full flex justify-center flex-col">
                ...
                <div class="md:w-10/12 mx-auto my-2">
                    <label for="remember" class="flex items-center">
                        <input id="remember" class=" bg-slate-200 rounded-lg w-5 mr-4 h-5 accent-sky-500 text-2xl "  type="checkbox">  <span class="mb-0.5 text-sm text-gray-600">Se connecter comme personnel</span>
                    </label>
                </div>
