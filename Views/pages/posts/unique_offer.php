...
$post = $params['post'] ?>
    ...
    <title>Offres | <?= $post['_title']?></title>
</head>
          ...
          <!--First section/hero-->
            <section class="w-full mt-3 flex flex-col">
                ...
                <div class=" my-5 overflow-hidden md:w-3/12 w-full  flex justify-between">
                    <span class="md:h-12 h-8/12 md:w-12 w-8/12 rounded md:text-2xl hover:bg-blue-600 text-gray-700 hover:text-white grid place-items-center"><a href="https://www.facebook.com/sharer/sharer.php?u=https://yourmain.com/blog/<?= $post['_id']?>" target="_blank"><i class="fab fa-facebook   "></i></a></span>
                    <span class="md:h-12 h-8/12 md:w-12 w-8/12 rounded md:text-2xl hover:bg-blue-600 text-gray-700 hover:text-white grid place-items-center"><a href="https://telegram.me/share/url?url=https://yourmain.com/blog/<?= $post['_id']?>&text=<?=$post['_title']?>" target="_blank"><i class="fab fa-telegram "></i></a></span>
                    <span class="md:h-12 h-8/12 md:w-12 w-8/12 rounded md:text-2xl hover:bg-blue-600 text-gray-700 hover:text-white grid place-items-center"><a href="https://twitter.com/intent/tweet?text=https://yourmain.com/blog/<?= $post['_id']?>" target="_blank"><i class="fab fa-twitter"></i></a></span>
                    <span class="md:h-12 h-8/12 md:w-12 w-8/12 rounded md:text-2xl hover:bg-blue-600 text-gray-700 hover:text-white grid place-items-center"><a href="https://api.whatsapp.com/send?text=https://yourmain.com/blog/<?= $post['_id']?>" target="_blank""><i class="fab fa-whatsapp"></i></a></span>
                </div>
            ...
            <section class="w-full mt-4 flex flex-col">
                ...
                <form id="comment-form" style="display: none;" action="/offres-d-emploie/post/<?= $post['_id'] ?>" method="POST" class="md:w-4/12 w-full h-full flex justify-center flex-col">
